...
import com.hfad.relevent.red.driverData;
import com.hfad.SAADApplication.R;

import java.util.List;

public class poiice_driverinfo extends RecyclerView.Adapter<poiice_driverinfo.ViewHolder>{

    Context context;
    List<driver> driverList;
    Task<Void> reference;

    public poiice_driverinfo(Context context , List<driver> driverList) {
    ...
    @NonNull
    @Override
    public poiice_driverinfo.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.new_item_layout, viewGroup, false);
        return new poiice_driverinfo.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull poiice_driverinfo.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
